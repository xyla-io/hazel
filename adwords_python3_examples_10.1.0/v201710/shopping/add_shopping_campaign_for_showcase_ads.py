...
def CreateShoppingCampaign(client, budget_id, merchant_id):
  ...
  """
  campaign_service = client.GetService('CampaignService', 'v201710')
...
def CreateAdGroup(client, campaign_id):
  ...
  """
  ad_group_service = client.GetService('AdGroupService', 'v201710')
...
def CreateShowcaseAd(client, adgroup, expanded_image_filepath,
  ...
  """
  ad_group_ad_service = client.GetService('AdGroupAdService', 'v201710')
...
def UploadImage(client, filepath):
  ...
  """
  media_service = client.GetService('MediaService', 'v201710')
