...
def main(client, campaign_id):
  ...
  feed_service = client.GetService('FeedService', version='v201705')
  feed_item_service = client.GetService('FeedItemService', version='v201705')
  feed_mapping_service = client.GetService(
      'FeedMappingService', version='v201705')
  campaign_feed_service = client.GetService(
      'CampaignFeedService', version='v201705')
