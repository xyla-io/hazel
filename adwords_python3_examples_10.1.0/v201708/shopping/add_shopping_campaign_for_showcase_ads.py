...
def CreateShoppingCampaign(client, budget_id, merchant_id):
  ...
  """
  campaign_service = client.GetService('CampaignService', 'v201708')
...
def CreateAdGroup(client, campaign_id):
  ...
  """
  ad_group_service = client.GetService('AdGroupService', 'v201708')
...
def UploadImage(client, filepath):
  ...
  """
  media_service = client.GetService('MediaService', 'v201708')
